...
export default function VocabularyPage() {
  ...
  const filteredVocabulary = useMemo(() => {
    return vocabularyCategories.filter((vocabulary) => {
      const matchesSearch =
        vocabulary.name.toLowerCase().includes(debouncedSearch.toLowerCase());
      
      const matchesFilter = 
        statusFilter === "all" || vocabulary.level === statusFilter;
  ...
  return (
    <section className='flex flex-col'>
      ...
      <CategoryList categories={filteredVocabulary} />
